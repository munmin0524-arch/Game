...
export const PHASE_HEADERS: Record<Phase, {
  ...
  mvp: {
    badge: 'MVP · ~5/29',
    oneLiner: '교과서가 달라도 OK — 2022 개정이면 누구나',
    title: '22개정 지식요인 기반 — 어떤 교과서를 쓰셔도 바로 시작',
    subtitle: '비상만이 아닌 전국 모든 학교의 교사가 쓸 수 있는 레디메이드 세트지. 교과서 종류에 관계없이 22개정 지식요인 단위로 묶어, 세팅 없이 즉시 사용하세요.',
    gradient: 'from-slate-700 to-slate-900',
    curation: [
      '{공통} 과목 > 학년 > 5/10/15/20분',
      '{수학} 학년 > 지식요인 ex) 분수 풀코스 패키지',
      '{영어} 학년 > 어휘/문법 ex) 동사 확장팩 (중등)',
    ],
  },
  phase1: {
    badge: '1차 고도화 · ~7/31',
    oneLiner: '초등을 잡으면 교실이 바뀐다',
    ...
    curation: [
      ...
      '초등 맞춤법 패키지',
      '초등 국어 독해',
      '저·고학년 초등 한국사 인물편·시대편',
      '초등 매캔 채널 연동 패키지',
    ],
  },
  phase2: {
    badge: '2차 고도화 · ~9/30',
    oneLiner: '콘텐츠가 스스로 자란다',
...
export const PHASE_TILES: Record<Phase, PhaseTile[]> = {
  ...
  phase1: [
    ...
    { key: 'maccann',    emoji: '🚀', label: '매캔(Math Canvas) 연동', sub: '초등 수학 학년·지식요인별', gradient: 'from-fuchsia-500 to-pink-500', preset: { search: '매캔' } },
...
// 수학 — 주제 관통 로드맵 팩 (대표 10개) — description에 학년 path
export const MVP_MATH_ROADMAP: QuestionSet[] = [
  { set_id: 'mvp-m-c1', host_member_id: 'quiz_party', title: '분수 풀코스', description: '초3-1 분수와소수 → 초3-2 분수와소수 → 초4-2 분수덧뺄셈 → 초5-1 약분통분 → 초5-1 분수덧뺄셈 → 초5-2 분수곱셈 → 초6-1 분수나눗셈 → 초6-2 분수나눗셈', subject: '수학', grade: null, tags: ['풀코스','수와연산','분수'], is_deleted: false, is_shared: false, original_set_id: null, created_at: '2026-04-01T09:00:00Z', updated_at: '2026-04-13T09:00:00Z', question_count: 660, difficulty: '중', thumbnail_variant: 1, play_count: 1024, rating_avg: 4.9, is_official: true, is_new: true, source: 'quiz_party' },
  { set_id: 'mvp-m-c2', host_member_id: 'quiz_party', title: '소수 풀코스', description: '초3-1·3-2 → 초4-2 소수덧뺄셈 → 초5-2 소수곱셈 → 초6-1·6-2 소수나눗셈', subject: '수학', grade: null, tags: ['풀코스','수와연산','소수'], is_deleted: false, is_shared: false, original_set_id: null, created_at: '2026-04-01T09:00:00Z', updated_at: '2026-04-12T09:00:00Z', question_count: 466, difficulty: '중', thumbnail_variant: 2, play_count: 812, rating_avg: 4.8, is_official: true, source: 'quiz_party' },
  { set_id: 'mvp-m-c7', host_member_id: 'quiz_party', title: '규칙·대응·비례 계보', description: '초4 규칙찾기 → 초5 대응관계 → 초6 비와비율·비례식 → 중1 정비례·반비례', subject: '수학', grade: null, tags: ['로드맵','변화와관계'], is_deleted: false, is_shared: false, original_set_id: null, created_at: '2026-03-28T09:00:00Z', updated_at: '2026-04-10T09:00:00Z', question_count: 441, difficulty: '중', thumbnail_variant: 3, play_count: 612, rating_avg: 4.7, is_official: true, source: 'quiz_party' },
  { set_id: 'mvp-m-c8', host_member_id: 'quiz_party', title: '방정식 완전정복', description: '중1 일차방정식 → 중2 연립일차방정식 → 공통1 이차방정식 → 공통1 여러가지 방정식·부등식', subject: '수학', grade: null, tags: ['완전정복','방정식'], is_deleted: false, is_shared: false, original_set_id: null, created_at: '2026-03-25T09:00:00Z', updated_at: '2026-04-09T09:00:00Z', question_count: 530, difficulty: '상', thumbnail_variant: 4, play_count: 745, rating_avg: 4.8, is_official: true, is_new: true, source: 'quiz_party' },
  { set_id: 'mvp-m-c9', host_member_id: 'quiz_party', title: '함수 로드맵', description: '중1 정비례·반비례 → 중2 일차함수 2종 → 공통2 함수·유리·무리함수', subject: '수학', grade: null, tags: ['로드맵','함수'], is_deleted: false, is_shared: false, original_set_id: null, created_at: '2026-03-22T09:00:00Z', updated_at: '2026-04-08T09:00:00Z', question_count: 700, difficulty: '상', thumbnail_variant: 5, play_count: 891, rating_avg: 4.9, is_official: true, source: 'quiz_party' },
  { set_id: 'mvp-m-c12',host_member_id: 'quiz_party', title: '평면도형의 성장', description: '초3 평면도형 → 초4 삼각형·사각형 → 중1 기본도형·평면도형 → 중2 삼각형·사각형의 성질', subject: '수학', grade: null, tags: ['로드맵','도형'], is_deleted: false, is_shared: false, original_set_id: null, created_at: '2026-03-18T09:00:00Z', updated_at: '2026-04-05T09:00:00Z', question_count: 603, difficulty: '중', thumbnail_variant: 0, play_count: 532, rating_avg: 4.7, is_official: true, source: 'quiz_party' },
  { set_id: 'mvp-m-c14',host_member_id: 'quiz_party', title: '도형의 성질 계보', description: '초6 각기둥·각뿔 → 중1 기본도형·작도 → 중2 삼각형·사각형의 성질', subject: '수학', grade: null, tags: ['계보','도형'], is_deleted: false, is_shared: false, original_set_id: null, created_at: '2026-03-15T09:00:00Z', updated_at: '2026-04-03T09:00:00Z', question_count: 607, difficulty: '중', thumbnail_variant: 1, play_count: 478, rating_avg: 4.7, is_official: true, source: 'quiz_party' },
  { set_id: 'mvp-m-c16',host_member_id: 'quiz_party', title: '측정 완전정복', description: '초3 시간·길이·들이·무게 → 초4 각도·평면도형 둘레 → 초5 다각형 넓이 → 초6 원의 넓이·부피', subject: '수학', grade: null, tags: ['완전정복','측정'], is_deleted: false, is_shared: false, original_set_id: null, created_at: '2026-03-12T09:00:00Z', updated_at: '2026-04-01T09:00:00Z', question_count: 525, difficulty: '하', thumbnail_variant: 2, play_count: 356, rating_avg: 4.6, is_official: true, source: 'quiz_party' },
  { set_id: 'mvp-m-c18',host_member_id: 'quiz_party', title: '그래프의 진화사', description: '초3 표·그림그래프 → 초4 막대·꺾은선 → 초6 띠·원그래프 → 중1 좌표평면 → 공통2 함수 그래프', subject: '수학', grade: null, tags: ['로드맵','자료와가능성'], is_deleted: false, is_shared: false, original_set_id: null, created_at: '2026-03-10T09:00:00Z', updated_at: '2026-03-30T09:00:00Z', question_count: 500, difficulty: '중', thumbnail_variant: 3, play_count: 412, rating_avg: 4.6, is_official: true, source: 'quiz_party' },
  { set_id: 'mvp-m-c20',host_member_id: 'quiz_party', title: 'AI 시대 수학 소양 팩', description: '데이터 해석 · 알고리즘적 사고 · 함수와 모델링 — 초6에서 중2까지 융합', subject: '수학', grade: null, tags: ['융합','AI소양'], is_deleted: false, is_shared: false, original_set_id: null, created_at: '2026-03-05T09:00:00Z', updated_at: '2026-03-28T09:00:00Z', question_count: 300, difficulty: '중', thumbnail_variant: 4, play_count: 289, rating_avg: 4.7, is_official: true, is_new: true, source: 'quiz_party' },
]

// 수학 — 학년 > 지식요인별 단일 단원 세트지 (시간 컷이 아닌 일반 단원 단위)
export const MVP_MATH_BY_GRADE_KE: QuestionSet[] = [
  { set_id: 'mvp-mke-01', host_member_id: 'quiz_party', title: '중1 정수와 유리수 — 단원 마스터', description: '음수의 도입 · 절댓값 · 사칙연산 · 분배법칙', subject: '수학', grade: '중등 수학 수학1', tags: ['지식요인','정수','유리수'], is_deleted: false, is_shared: false, original_set_id: null, created_at: '2026-04-10T09:00:00Z', updated_at: '2026-04-13T09:00:00Z', question_count: 24, difficulty: '하', thumbnail_variant: 1, play_count: 612, rating_avg: 4.7, is_official: true, source: 'quiz_party' },
  { set_id: 'mvp-mke-02', host_member_id: 'quiz_party', title: '중1 일차방정식 — 핵심 정리', description: '동치관계 · 이항 · 활용 문제 (속력·농도·일률)', subject: '수학', grade: '중등 수학 수학1', tags: ['지식요인','일차방정식'], is_deleted: false, is_shared: false, original_set_id: null, created_at: '2026-04-09T09:00:00Z', updated_at: '2026-04-12T09:00:00Z', question_count: 22, difficulty: '중', thumbnail_variant: 2, play_count: 489, rating_avg: 4.7, is_official: true, source: 'quiz_party' },
  { set_id: 'mvp-mke-03', host_member_id: 'quiz_party', title: '중1 작도와 합동 — 단원 정리', description: '기본 작도 · 삼각형 합동조건 (SSS/SAS/ASA)', subject: '수학', grade: '중등 수학 수학1', tags: ['지식요인','작도','합동'], is_deleted: false, is_shared: false, original_set_id: null, created_at: '2026-04-08T09:00:00Z', updated_at: '2026-04-11T09:00:00Z', question_count: 18, difficulty: '중', thumbnail_variant: 3, play_count: 312, rating_avg: 4.6, is_official: true, source: 'quiz_party' },
  { set_id: 'mvp-mke-04', host_member_id: 'quiz_party', title: '중2 연립일차방정식 — 마스터', description: '대입법 · 가감법 · 연립방정식 활용 (속력·합금)', subject: '수학', grade: '중등 수학 수학2', tags: ['지식요인','연립방정식'], is_deleted: false, is_shared: false, original_set_id: null, created_at: '2026-04-07T09:00:00Z', updated_at: '2026-04-10T09:00:00Z', question_count: 26, difficulty: '중', thumbnail_variant: 4, play_count: 567, rating_avg: 4.8, is_official: true, is_new: true, source: 'quiz_party' },
  { set_id: 'mvp-mke-05', host_member_id: 'quiz_party', title: '중2 일차함수 — 핵심 정리', description: '기울기·y절편 · 평행·일치 · 그래프 해석', subject: '수학', grade: '중등 수학 수학2', tags: ['지식요인','일차함수'], is_deleted: false, is_shared: false, original_set_id: null, created_at: '2026-04-06T09:00:00Z', updated_at: '2026-04-09T09:00:00Z', question_count: 28, difficulty: '중', thumbnail_variant: 5, play_count: 678, rating_avg: 4.8, is_official: true, source: 'quiz_party' },
  { set_id: 'mvp-mke-06', host_member_id: 'quiz_party', title: '중2 도형의 닮음 — 단원', description: '닮음의 정의 · 닮음비 · 평행선과 비례', subject: '수학', grade: '중등 수학 수학2', tags: ['지식요인','닮음'], is_deleted: false, is_shared: false, original_set_id: null, created_at: '2026-04-05T09:00:00Z', updated_at: '2026-04-08T09:00:00Z', question_count: 22, difficulty: '중', thumbnail_variant: 0, play_count: 412, rating_avg: 4.7, is_official: true, source: 'quiz_party' },
  { set_id: 'mvp-mke-07', host_member_id: 'quiz_party', title: '초5 분수의 덧셈·뺄셈 — 단원', description: '약분 · 통분 · 이분모 분수 덧뺄셈', subject: '수학', grade: '초등 수학 5-1', tags: ['지식요인','분수'], is_deleted: false, is_shared: false, original_set_id: null, created_at: '2026-04-04T09:00:00Z', updated_at: '2026-04-07T09:00:00Z', question_count: 18, difficulty: '하', thumbnail_variant: 1, play_count: 523, rating_avg: 4.8, is_official: true, source: 'quiz_party' },
  { set_id: 'mvp-mke-08', host_member_id: 'quiz_party', title: '초6 비와 비율 — 단원', description: '비의 성질 · 비례식 · 백분율 활용', subject: '수학', grade: '초등 수학 6-1', tags: ['지식요인','비율'], is_deleted: false, is_shared: false, original_set_id: null, created_at: '2026-04-03T09:00:00Z', updated_at: '2026-04-06T09:00:00Z', question_count: 20, difficulty: '하', thumbnail_variant: 2, play_count: 389, rating_avg: 4.7, is_official: true, source: 'quiz_party' },
  { set_id: 'mvp-mke-09', host_member_id: 'quiz_party', title: '공통1 다항식 — 단원 정리', description: '곱셈공식 · 인수분해 · 나눗셈 정리', subject: '수학', grade: '고등 수학 공통수학1', tags: ['지식요인','다항식'], is_deleted: false, is_shared: false, original_set_id: null, created_at: '2026-04-02T09:00:00Z', updated_at: '2026-04-05T09:00:00Z', question_count: 30, difficulty: '상', thumbnail_variant: 3, play_count: 312, rating_avg: 4.7, is_official: true, source: 'quiz_party' },
  { set_id: 'mvp-mke-10', host_member_id: 'quiz_party', title: '공통1 집합과 명제 — 마스터', description: '집합 연산 · 명제·역·이·대우 · 충분·필요조건', subject: '수학', grade: '고등 수학 공통수학1', tags: ['지식요인','집합','명제'], is_deleted: false, is_shared: false, original_set_id: null, created_at: '2026-04-01T09:00:00Z', updated_at: '2026-04-04T09:00:00Z', question_count: 24, difficulty: '상', thumbnail_variant: 4, play_count: 234, rating_avg: 4.6, is_official: true, source: 'quiz_party' },
]
...
// 영어 — 문법 테마 로드맵 — description에 학년 path
export const MVP_ENG_GRAMMAR_THEME: QuestionSet[] = [
  { set_id: 'mvp-egt-01', host_member_id: 'quiz_party', title: '시제 대서사시 팩', description: '중1 현재진행형 → 중1 be동사 과거형 → 중1 일반동사 과거형 → 중2 현재완료 → 공1 과거완료', subject: '영어', grade: null, tags: ['문법 로드맵','시제'], is_deleted: false, is_shared: false, original_set_id: null, created_at: '2026-03-26T09:00:00Z', updated_at: '2026-04-10T09:00:00Z', question_count: 250, difficulty: '중', thumbnail_variant: 1, play_count: 612, rating_avg: 4.9, is_official: true, is_new: true, source: 'quiz_party' },
  { set_id: 'mvp-egt-02', host_member_id: 'quiz_party', title: '동사의 확장 팩', description: '중1 be동사 → 일반동사 → 감각동사+형용사 → 목적어 두 개 동사 → 조동사 will·can → 중2 사역동사 → 지각동사 → 공2 동사+목적어+to부정사', subject: '영어', grade: null, tags: ['문법 로드맵','동사'], is_deleted: false, is_shared: false, original_set_id: null, created_at: '2026-03-24T09:00:00Z', updated_at: '2026-04-08T09:00:00Z', question_count: 320, difficulty: '중', thumbnail_variant: 2, play_count: 478, rating_avg: 4.8, is_official: true, source: 'quiz_party' },
  { set_id: 'mvp-egt-03', host_member_id: 'quiz_party', title: 'to부정사 풀코스 팩', description: '중1 명사처럼 → 부사처럼 → 중2 형용사처럼 → 동사+목적어+to부정사 → 공2 seem to+완료부정사', subject: '영어', grade: null, tags: ['문법 로드맵','to부정사'], is_deleted: false, is_shared: false, original_set_id: null, created_at: '2026-03-22T09:00:00Z', updated_at: '2026-04-06T09:00:00Z', question_count: 220, difficulty: '중', thumbnail_variant: 3, play_count: 412, rating_avg: 4.7, is_official: true, source: 'quiz_party' },
  { set_id: 'mvp-egt-04', host_member_id: 'quiz_party', title: '관계사 올인원 팩', description: '중2 주격 관계대명사 → 목적격 관계대명사 → 공1 관계부사 where → 앞 문장 받는 which → 공2 분사의 후치 수식', subject: '영어', grade: null, tags: ['문법 로드맵','관계사'], is_deleted: false, is_shared: false, original_set_id: null, created_at: '2026-03-20T09:00:00Z', updated_at: '2026-04-04T09:00:00Z', question_count: 280, difficulty: '상', thumbnail_variant: 4, play_count: 389, rating_avg: 4.7, is_official: true, source: 'quiz_party' },
  { set_id: 'mvp-egt-05', host_member_id: 'quiz_party', title: '비교 구문 로드맵 팩', description: '중1 비교급 → 중2 최상급 → 원급 비교 → 공2 as many[much] 명사 as', subject: '영어', grade: null, tags: ['문법 로드맵','비교'], is_deleted: false, is_shared: false, original_set_id: null, created_at: '2026-03-18T09:00:00Z', updated_at: '2026-04-02T09:00:00Z', question_count: 180, difficulty: '중', thumbnail_variant: 5, play_count: 312, rating_avg: 4.6, is_official: true, source: 'quiz_party' },
  { set_id: 'mvp-egt-06', host_member_id: 'quiz_party', title: '접속사·연결어 계보 팩', description: '중1 when → that → 중2 if → 공1 while·whereas → 공2 조건절 unless', subject: '영어', grade: null, tags: ['문법 로드맵','접속사'], is_deleted: false, is_shared: false, original_set_id: null, created_at: '2026-03-16T09:00:00Z', updated_at: '2026-03-30T09:00:00Z', question_count: 200, difficulty: '중', thumbnail_variant: 0, play_count: 256, rating_avg: 4.6, is_official: true, source: 'quiz_party' },
  { set_id: 'mvp-egt-07', host_member_id: 'quiz_party', title: '특수 구문 배틀 팩', description: '중1 감탄문 → 중2 so~that·not only but also·간접의문문·가주어 it → 공1 부정어 도치·wh-명사절 → 공2 with+분사', subject: '영어', grade: null, tags: ['문법 로드맵','특수구문'], is_deleted: false, is_shared: false, original_set_id: null, created_at: '2026-03-14T09:00:00Z', updated_at: '2026-03-28T09:00:00Z', question_count: 240, difficulty: '상', thumbnail_variant: 1, play_count: 234, rating_avg: 4.5, is_official: true, source: 'quiz_party' },
  { set_id: 'mvp-egt-08', host_member_id: 'quiz_party', title: '수동·분사 구문 팩', description: '중2 수동태 → 공2 분사의 후치 수식 → 공2 with+명사+현재·과거분사', subject: '영어', grade: null, tags: ['문법 로드맵','수동분사'], is_deleted: false, is_shared: false, original_set_id: null, created_at: '2026-03-12T09:00:00Z', updated_at: '2026-03-26T09:00:00Z', question_count: 160, difficulty: '상', thumbnail_variant: 2, play_count: 198, rating_avg: 4.6, is_official: true, source: 'quiz_party' },
]
...
// 매캔 = Math Canvas (초등 수학 전용 콘텐츠 채널). 학년별·지식요인별로 연동.
export const PHASE1_MACCANN: QuestionSet[] = [
  { set_id: 'p1-mc-01', host_member_id: 'quiz_party', title: '매캔 연동 · 초3 곱셈 마스터', description: '한 자리수·두 자리수 곱셈 — 매스 캔버스 게임 연동', subject: '수학', grade: '초등 수학 3-1', tags: ['매캔','초3','곱셈'], is_deleted: false, is_shared: false, original_set_id: null, created_at: '2026-04-12T09:00:00Z', updated_at: '2026-04-13T09:00:00Z', question_count: 24, difficulty: '하', thumbnail_variant: 1, play_count: 1156, rating_avg: 4.9, is_official: true, is_new: true, source: 'quiz_party' },
  { set_id: 'p1-mc-02', host_member_id: 'quiz_party', title: '매캔 연동 · 초3 나눗셈 입문', description: '나눗셈의 의미·몫과 나머지 — 매스 캔버스 미션', subject: '수학', grade: '초등 수학 3-2', tags: ['매캔','초3','나눗셈'], is_deleted: false, is_shared: false, original_set_id: null, created_at: '2026-04-12T09:00:00Z', updated_at: '2026-04-13T09:00:00Z', question_count: 22, difficulty: '하', thumbnail_variant: 2, play_count: 989, rating_avg: 4.9, is_official: true, is_new: true, source: 'quiz_party' },
  { set_id: 'p1-mc-03', host_member_id: 'quiz_party', title: '매캔 연동 · 초4 분수 기초', description: '진분수·가분수·대분수 — 매스 캔버스 도형 시각화', subject: '수학', grade: '초등 수학 4-2', tags: ['매캔','초4','분수'], is_deleted: false, is_shared: false, original_set_id: null, created_at: '2026-04-11T09:00:00Z', updated_at: '2026-04-13T09:00:00Z', question_count: 25, difficulty: '하', thumbnail_variant: 3, play_count: 878, rating_avg: 4.8, is_official: true, source: 'quiz_party' },
  { set_id: 'p1-mc-04', host_member_id: 'quiz_party', title: '매캔 연동 · 초4 사각형의 성질', description: '직사각형·평행사변형·마름모 — 매스 캔버스 도형 작도 모드', subject: '수학', grade: '초등 수학 4-2', tags: ['매캔','초4','도형'], is_deleted: false, is_shared: false, original_set_id: null, created_at: '2026-04-10T09:00:00Z', updated_at: '2026-04-12T09:00:00Z', question_count: 20, difficulty: '하', thumbnail_variant: 4, play_count: 712, rating_avg: 4.7, is_official: true, source: 'quiz_party' },
  { set_id: 'p1-mc-05', host_member_id: 'quiz_party', title: '매캔 연동 · 초5 약분과 통분', description: '최대공약수·최소공배수 활용 — 매스 캔버스 분수 캔버스', subject: '수학', grade: '초등 수학 5-1', tags: ['매캔','초5','약분','통분'], is_deleted: false, is_shared: false, original_set_id: null, created_at: '2026-04-09T09:00:00Z', updated_at: '2026-04-12T09:00:00Z', question_count: 26, difficulty: '하', thumbnail_variant: 5, play_count: 678, rating_avg: 4.8, is_official: true, source: 'quiz_party' },
  { set_id: 'p1-mc-06', host_member_id: 'quiz_party', title: '매캔 연동 · 초5 분수의 곱셈', description: '진분수·대분수의 곱셈 — 매스 캔버스 비율 시각화', subject: '수학', grade: '초등 수학 5-2', tags: ['매캔','초5','분수곱셈'], is_deleted: false, is_shared: false, original_set_id: null, created_at: '2026-04-08T09:00:00Z', updated_at: '2026-04-11T09:00:00Z', question_count: 24, difficulty: '중', thumbnail_variant: 0, play_count: 567, rating_avg: 4.8, is_official: true, source: 'quiz_party' },
  { set_id: 'p1-mc-07', host_member_id: 'quiz_party', title: '매캔 연동 · 초5 다각형 둘레·넓이', description: '평행사변형·삼각형·사다리꼴 넓이 — 매스 캔버스 측정 모드', subject: '수학', grade: '초등 수학 5-1', tags: ['매캔','초5','측정','넓이'], is_deleted: false, is_shared: false, original_set_id: null, created_at: '2026-04-07T09:00:00Z', updated_at: '2026-04-10T09:00:00Z', question_count: 22, difficulty: '중', thumbnail_variant: 1, play_count: 489, rating_avg: 4.7, is_official: true, source: 'quiz_party' },
  { set_id: 'p1-mc-08', host_member_id: 'quiz_party', title: '매캔 연동 · 초6 비와 비율', description: '비의 성질·비례식·백분율 — 매스 캔버스 데이터 시각화', subject: '수학', grade: '초등 수학 6-1', tags: ['매캔','초6','비율'], is_deleted: false, is_shared: false, original_set_id: null, created_at: '2026-04-06T09:00:00Z', updated_at: '2026-04-09T09:00:00Z', question_count: 25, difficulty: '중', thumbnail_variant: 2, play_count: 612, rating_avg: 4.8, is_official: true, is_new: true, source: 'quiz_party' },
  { set_id: 'p1-mc-09', host_member_id: 'quiz_party', title: '매캔 연동 · 초6 분수의 나눗셈', description: '분수÷분수·분수÷자연수 — 매스 캔버스 단계별 가이드', subject: '수학', grade: '초등 수학 6-2', tags: ['매캔','초6','분수나눗셈'], is_deleted: false, is_shared: false, original_set_id: null, created_at: '2026-04-05T09:00:00Z', updated_at: '2026-04-08T09:00:00Z', question_count: 28, difficulty: '중', thumbnail_variant: 3, play_count: 523, rating_avg: 4.8, is_official: true, source: 'quiz_party' },
  { set_id: 'p1-mc-10', host_member_id: 'quiz_party', title: '매캔 연동 · 초6 원의 둘레·넓이', description: '원주율·원의 넓이 공식 — 매스 캔버스 인터랙티브 도형', subject: '수학', grade: '초등 수학 6-2', tags: ['매캔','초6','원','측정'], is_deleted: false, is_shared: false, original_set_id: null, created_at: '2026-04-04T09:00:00Z', updated_at: '2026-04-07T09:00:00Z', question_count: 20, difficulty: '중', thumbnail_variant: 4, play_count: 412, rating_avg: 4.7, is_official: true, source: 'quiz_party' },
]
...
export const PHASE2_REMIX: QuestionSet[] = [
  { set_id: 'p2-rm-01', host_member_id: 'ai-remix', host_nickname: 'AI 자동 생성', title: '🤖 AI 재가공 — 우리반 학생 수준 맞춤 분수 팩', subject: '수학', grade: null, tags: ['AI 재가공','맞춤'], is_deleted: false, is_shared: false, original_set_id: 'p2-tp-01', created_at: '2026-04-13T09:00:00Z', updated_at: '2026-04-13T09:00:00Z', question_count: 25, difficulty: '하', thumbnail_variant: 1, play_count: 234, rating_avg: 4.7, like_count: 312, download_count: 89, is_new: true, source: 'community' },
  { set_id: 'p2-rm-02', host_member_id: 'ai-remix', host_nickname: 'AI 자동 생성', title: '🤖 AI 재가공 — 영어 시제, 우리 학교 시험 스타일', subject: '영어', grade: null, tags: ['AI 재가공','시험대비'], is_deleted: false, is_shared: false, original_set_id: 'p2-tp-02', created_at: '2026-04-12T09:00:00Z', updated_at: '2026-04-13T09:00:00Z', question_count: 30, difficulty: '중', thumbnail_variant: 2, play_count: 198, rating_avg: 4.6, like_count: 245, download_count: 67, is_new: true, source: 'community' },
  { set_id: 'p2-rm-03', host_member_id: 'ai-remix', host_nickname: 'AI 자동 생성', title: '🤖 AI 재가공 — 한국사 인물, 캐주얼 톤', subject: '한국사', grade: null, tags: ['AI 재가공','캐주얼'], is_deleted: false, is_shared: false, original_set_id: 'p2-tp-03', created_at: '2026-04-11T09:00:00Z', updated_at: '2026-04-12T09:00:00Z', question_count: 28, difficulty: '하', thumbnail_variant: 3, play_count: 156, rating_avg: 4.6, like_count: 189, download_count: 54, source: 'community' },
  { set_id: 'p2-rm-04', host_member_id: 'ai-remix', host_nickname: 'AI 자동 생성', title: '🤖 AI 재가공 — 화학 반응식, 시각화 강화 버전', subject: '과학', grade: null, tags: ['AI 재가공','시각화'], is_deleted: false, is_shared: false, original_set_id: 'p2-tp-05', created_at: '2026-04-10T09:00:00Z', updated_at: '2026-04-11T09:00:00Z', question_count: 22, difficulty: '중', thumbnail_variant: 4, play_count: 134, rating_avg: 4.5, like_count: 156, download_count: 43, source: 'community' },
  { set_id: 'p2-rm-05', host_member_id: 'ai-remix', host_nickname: 'AI 자동 생성', title: '🤖 AI 재가공 — 맞춤법, 4학년 어휘 수준', subject: '국어', grade: null, tags: ['AI 재가공','어휘조정'], is_deleted: false, is_shared: false, original_set_id: 'p2-tp-04', created_at: '2026-04-09T09:00:00Z', updated_at: '2026-04-10T09:00:00Z', question_count: 30, difficulty: '하', thumbnail_variant: 5, play_count: 112, rating_avg: 4.5, like_count: 134, download_count: 38, source: 'community' },
  { set_id: 'p2-rm-06', host_member_id: 'ai-remix', host_nickname: 'AI 자동 생성', title: '🤖 AI 재가공 — 일차함수 그래프, 인터랙티브 강화', subject: '수학', grade: null, tags: ['AI 재가공','인터랙티브'], is_deleted: false, is_shared: false, original_set_id: 'p2-tp-06', created_at: '2026-04-08T09:00:00Z', updated_at: '2026-04-09T09:00:00Z', question_count: 24, difficulty: '중', thumbnail_variant: 0, play_count: 98, rating_avg: 4.6, like_count: 112, download_count: 32, source: 'community' },
]
